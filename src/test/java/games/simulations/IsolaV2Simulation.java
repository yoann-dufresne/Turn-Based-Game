...
import games.isolaV2.IsolaHostV2;


/**
 * IsolaSimulation : the main method who launch the host and start an Isola game.
 * 
 * @author Guillaume Ferlin - Robin Lewandowicz - Yassine Badache
 */
public class IsolaV2Simulation {

	
	public static void main(String[] args) {
		
		IsolaHostV2 host = new IsolaHostV2();
		host.playGame();
